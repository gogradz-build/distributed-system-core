...
const formData = ref({
    ...
    ref_id: props.shop.ref_id,
    credit_limit: props.shop.credit_limit,
    email: props.shop.email,
    telephone_number: props.shop.telephone_number,
});
...
const handleSubmit = (e) => {
    ...
    axios.put(`/shops/${props.shop.id}`, formData.value)
        .then(response => {
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="owner_name"
                                            placeholder="Enter owner_name" v-model="formData.owner_name" required>
                                        <div class="invalid-feedback">
