  ...
  <div class="container mt-4">
    ...
    <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="invoice-print.html" rel="noopener" target="_blank" class="btn btn-default" @click="printPage"><i class="fas fa-print"></i> Print</a>
...
export default {
  ...
  methods: {
    printPage() {
      ...
      document.title = this.data.title || "Print Preview";
