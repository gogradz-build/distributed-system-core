...
<template>
    <AdminLayout>
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="mt-2">PRODUCTS ADJUSTMENT</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-secondary">
                    <div class="card-body">
                        <h6 style="font-weight: 700;" class="">PRODUCT ADJUSTMENT TABLE</h6>
                        <hr>
                        <!-- Add ID to the table -->
                            ...
                            <tbody>
                                <tr v-for="(product, index) in products" :key="product.id">
                                    ...
                                    <td class=" justify-content-center align-items-center">
                                        <a :href="route('adjustments.edit', product.id)"><img src="/images/icon/edit.png" alt="" width="25px" height="25px" class="mr-2 table-action-icon"></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
