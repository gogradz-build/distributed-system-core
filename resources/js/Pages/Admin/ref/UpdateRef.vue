...
const formData = ref({
    first_name: props.refData.first_name,
    last_name: props.refData.last_name,
    phone_number: props.refData.phone_number,
    address: props.refData.address,
    email: props.refData.email,
    nic_number: props.refData.nic_number,
    register_number: props.refData.register_number,
});
...
const handleSubmit = (e) => {
    ...
    axios.put(`/refs/${props.refData.id}`, formData.value)
        .then(response => {
            if (response?.data?.message) {
                localStorage.setItem('successMessage', response.data.message);
                window.location.href = route('admin.show.ref')
...
<template>
    <AdminLayout>
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="mt-2">UPDATE REF</h4>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right mt-2">
                    <li class="breadcrumb-item"><a :href="route('admin.dashboard')">Home</a></li>
                    <li class="breadcrumb-item"><a :href="route('admin.show.ref')">Sales Ref</a></li>
                    <li class="breadcrumb-item active">Update Ref</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        <div class="row">
            <div class="col-12">
                <div class="card card-secondary ">
                    <div class="card-header card-header-background">
                        <h3 class="card-title">Personal Ref Details</h3>
