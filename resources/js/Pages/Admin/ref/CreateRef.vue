...
const handleSubmit = (e) => {
    ...
    axios.post('/refs', formData.value)
        .then(response => {
            ...
            <div class="col-12">
                <div class="card card-secondary ">
                    <div class="card-header card-header-background">
                        <h3 class="card-title">Sales Ref Personal Details </h3>
                        ...
                        <form class="needs-validation" ref="formRef" @submit.prevent="handleSubmit" novalidate>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary">Create Ref</button>
                                </div>
                            </div>
                        </form>
                    </div>
